...
Минимальный код, который должен быт написан, чтобы наследовать тип в QOM
включает в себя:
...
парадигму программирования для моделирования виртуальных платформ и их 
компонент. Предназначение описанных контейнеров данных и функций аналогично 
принятому в ООП.
...
вычислительно нагруженные действия при обработке событий, так как это приводит к
ухудшению отзывчивости интерфейса и общему снижению удобства его использования.
