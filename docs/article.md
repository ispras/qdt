...
Dynamips [[$](#Dynamips)]. Последний распространяется с открытым исходным кодом.
Его разработка на данный момент заморожена, если не считать проект
GNS3 [[$](#GNS3)], который использует Dynamips для эмуляции маршрутизаторов,
...
* <a name="Dynamips"></a>_Что-нибудь про динамипс_
