...
<!--
Соглешение об именовании ссылок:
...
Якори расставляются так <a name=preffix.MyName>$</a>, где $ - ставится только в
том случае, если предполагается расстановка автоматической нумерации. Якорь
...
![Схема маршрутизатора C2621XM](C2600.svg)
Рисунок <a name="pic.C2621XM">$</a> --- Схема маршрутизатора C2621XM
