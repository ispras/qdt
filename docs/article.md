...
краткость кода ВВМ. Инициализация прерываний заняла 20 строк кода, что составляет
менее 1% от кода всей ВВМ Q35.

Все подсчёты выполнены вручную по истории Git.
