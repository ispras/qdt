...
связана с тем, что эти устройства реализованы без строгого
соблюдения принятого в QEMU стиля оформления моделей устройств.
Приведение устройств к единому стилю оформления можно вынести на этап
...
инструмента без учета работы над прерываниями.
...
Это позволило произвести регистрацию прерываний в цикле.
Изменения, касающиеся прерываний, никак не влияют на
работу самой ВВМ и служат для более наглядного представления связей между устройствами.
...
на несколько массивов. Благодаря этому последовательность инструкций связывающая
устройства прерываниями была свёрнута в циклы.
