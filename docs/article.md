...
* объявление (регистрация) _свойств устройства_;

* объявление (регистрация) функции _реализации_ устройства;

* объявление (регистрация) _состояния устройства_.
...
структуры объекта.
Наиболее яркий пример применения второго этапа --- свойства (надо пояснить, т.к. про свойства ).
...
и возвращающую компилируемый код-шаблон. В нем размещен минимальный функционал,
...
Отдельно нужно сказать о вычислительных (виртуальных?) машинах. Хотя описания вычислительных
