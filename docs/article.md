...
<!--
Перед подачей в pandoc статья должна быть предобработана сценарием
md_preprocessor.py. Он осуществляет автоматизацию ссылок. Ниже приводятся
...
Вторая из них отличается тем, что, несмотря на многообразие
...
Кроме это следует учитывать семантику фрагментов (близкие по смыслу фрагменты
...
Генератор заготовок предоставляет API упрощающей учёт этих и других
особенностей.
