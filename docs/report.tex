...
\vfill
\begin{itemize}
\item Автоматизирован начальный этап разработки машины
\item Настройка генерации осуществляется на языке Python
\item Объём настройки генерации заготовки устройства в 11-25 раз больше объёма
сгенерированной заготовки
\item Разработан GUI, в т.ч. с визуализацией машины в виде схемы
\item Поддерживается разработка машин сложности, сравнимой с Intel Q35
