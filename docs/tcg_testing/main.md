...
В качестве эталона был выбран персональный компьютер на базе процессора
архитектуры AMD64.
Были протестированы реализации архитектур ARM и MIPS для Qemu версии 2.5.0.
Реализация MSP430 была протестирована для Qemu, находящейся по адресу
