...
-->
Термин "эталон для тестирования" ("test oracle") встречается в работе
[[$](#ref.oracle_testing)].
...
В случае тестирования реализации процессорной архитектуры в Qemu, на вход
подается машинный код.
<!--
...
При выполнении этот машинный код должен в определенных точках давать выход,
одинаковый с выходом в тех же точках, но если бы оригинальный машинный код был
выполнен в отсутствующем эталоне (см. рис. [$](#pic.Approach_base).
...
* Уход от машинной зависимости тестов, которые в существующих решениях пишутся на
языке ассемблера или генерируются в виде машинного кода, то есть являются
...
инструкций и сам подход. Необходимо оценить насколько больше инструкций будет
покрыто.
