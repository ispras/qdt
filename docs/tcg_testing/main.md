...
динамического транслятора.
Данные эталоны используется для для проверки правильности выходных значений для
данного набора входных значений.
...
Однако не всегда есть доступ к таким эталонам.
Это обучловлено недоступностью необходимого реального оборудования, отсутствия
эталонной виртуальной машины и другой реализации двоичного динамического
...
эталона для сравнения и реализация на его основе программного средства
