...
написанной на языке Си, под гостевую и архитектуру эталона.
А также в ее запуске в Qemu и эталоне с целью сравнить поведение данной
программы.
...
покрытием инструкций тестируемой реализации определенной процессорной
