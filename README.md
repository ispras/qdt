...
Tests for TCG front-end tester are C programs.
...
Tests for TCG front-end testing contain comments (that starts on `$`) with
special commands. These commands specify breakpoints positions and names of
variables for comparison. The following commands are supported:
* `br` &mdash; set breakpoint for checking of line number accordance;
* `brc` &mdash; set breakpoint for cyclical checking of line number accordance;
* `bre` &mdash; set breakpoint to end of test;
* `ch` &mdash; set breakpoint for checking of line number accordance and
variables values accordance;
* `chc` &mdash; set breakpoint for cyclical checking of line number accordance
