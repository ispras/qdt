...
ancestors.
    ...
    def iter_self_and_ancestors(self):
        yield self
...
Notifications are issued for many machine composition events.
    ...
    :param type_impl:
        ...
        for t in rqom_type.iter_self_and_ancestors():
            for prop in t.properties:
                # save unique RQObjectProperty for each insteanse
                i.properties[prop.name] = RQObjectProperty(prop.prop)
    ...
    def on_obj_class_prop_add(self):
        ...
        self.tree.addr2type[type_addr].properties.append(
            RQObjectProperty(prop)
        )
