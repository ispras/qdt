...
class TextCanvas(Canvas, CurrentKeyboard, object):
    ...
    def __init__(self, master, **kw):
        ...
        self._lineno_multipler = kw.pop("lineno_multipler", 1)
        self._lineno_fmt = kw.pop("ineno_fmt", "%u")
    ...
    @property
    def lineno_multipler(self):
        return self._lineno_multipler

    @lineno_multipler.setter
    def lineno_multipler(self, lineno_multipler):
        self._lineno_multipler = lineno_multipler
        self.draw()

    @property
    def ineno_fmt(self):
        return self._ineno_fmt

    @ineno_fmt.setter
    def ineno_fmt(self, ineno_fmt):
        self._ineno_fmt = ineno_fmt
        self.draw()
    ...
    def _xview_scroll(self, step, unit):
        ...
        if unit == "pages":
            ...
            raise ValueError("Unsupported scroll unit: " + unit)
    ...
    def draw(self):
        ...
        fmt, mult = self._lineno_fmt, self._lineno_multipler
        ...
        self._page_width = max(0,
            self.winfo_width() - lineno_width - self._lineno_padding
        )
