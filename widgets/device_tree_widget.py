...
class DeviceTreeWidget(GUIDialog):
    def __init__(self, root, *args, **kw):
        ...
        add_scrollbars_native(self, dt, rowspan = 4)
        ...
        fr_at = VarLabelFrame(self, text = _("Select arch filter"))
        fr_at.grid(row = 0, column = 2, sticky = "SEWN")
        ...
        arch_buttons.pack(expand = 1, fill = "x")
        ...
        arch_selector, scrolltag = add_scrollbars(arch_selector, GUIFrame)
