...
class QTrace(object):
    def __init__(self, lines):
        ...
        # search for "qemu_log_mask_and_addr(CPU_LOG_EXEC" for trace
        # message format.
        addrs = []
        for c in l0:
            if c == "[":
        ...
        # addrs[0] is `cs_base`, addrs[1] is `pc`,
        # addrs[2] is 0 from "0x" prefix of flags, addrs[3] is `flags`
        try:
        ...
        while l0 is not EOL:
            ...
            if is_trace(l0):
                ...
                while l1 is not EOL:
                    ...
                    if is_trace(l0) or is_linking(l1) or is_in_asm(l1):
                        l0 = l1
                        break
                    trace.append(l1)
                    l1 = yield; lineno += 1
