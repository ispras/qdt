...
# The window is automaticlay shifted when necessery by adding/removing rows
# beyond the window.
# Curretly 1024 instructions are showed to user.
TV_WINDOW_SIZE = 1 << 10

# TODO: If user see all showed instructions, scrolling does not works.
# For bigger dispalays we shoud either catch mouse whell, arrow buttons and
...
class InstructionsTreeview(VarTreeview, object):
    ...
    def see_instruction(self, idx):
        ...
        # But the feedback mast always be passed to an outer observer.
    ...
    def _shift_window(self, shift):
        ...
        if actual_shift > 0:
            ...
            # actual_shift can be bigger than windows size (absolute value)
