...
SAME_ALG = {
    ...
    list : _is_b_itereable(same_sets),
    set : _is_b_itereable(same_sets),
    GeneratorType : _is_b_itereable(same_sets),
    tuple : _is_b_itereable(same_vectors)
}
