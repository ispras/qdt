...
True
    ...
    def __init__(self,
        word_size_bits = 4, # 16 byte words
        size = None,
    ):
        """
:param word_size_bits: log2 of word size.
    A word is hexadecimal ASCII representation of that word offset.

:param size: logical size of the stream.
    `None`: size is big enough to fit all words.
        """
