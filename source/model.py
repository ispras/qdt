...
class Enumeration(Type):
    ...
    def __init__(self, type_name, elems_list, enum_name = ""):
        ...
        for key, val in elems_list:
            self._elems[key] = EnumerationElement(self, key,
    ...
    def gen_chunks(self, generator):
        ...
        last_num = len(self._elems) - 1
        for i, f in enumerate(self._elems.values()):
...
class Macro(Type):
    ...
    def new_from_dict(_dict):
        return Macro(_dict[HDB_MACRO_NAME],
