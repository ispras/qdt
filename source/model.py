                ...
                if inherit_references:
                    ...
                    for ref in t.type.definer.references:
                        ...
                        if ref.definer is self:
                            ...
                            # foreign type (ref) from the another file, which
                            # will be included in the resulting file (since we
                            # use some type from it). In this case, inclusion
                            # of that definer must be placed below the
                            # inclusion of the another file in resulting file.
                            for tt in l:
