...
"""
        ...
        for ch in chunks:
            ...
            style = " ".join("%s=%s" % i for i in ch.appearance.items())
    ...
    def optimize_inclusions(self,
        ...
        """
:param graphs_prefix:
    is a prefix of the path for dumping intermedate chunk graphs.
    Graphs paths will be `graphs_prefix + ".N.gw"` where N is a serial number.
        """
