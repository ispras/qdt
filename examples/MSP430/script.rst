...
Система находит различия в тесте `e_abs_32`.
По всей видимости, ошибка в стандартной библиотеке.
См. дизассемблированный код `e_abs_32.disas` в каталоге с промежуточных
файлов.
C2T выводит его путь в начале работы::

	Intermediates: /path/to/c2t/msp430g2553/ir
